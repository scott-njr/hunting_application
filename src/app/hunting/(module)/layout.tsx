...
export default async function HuntingModuleLayout({ children }: { children: React.ReactNode }) {
  ...
  if (moduleTier === 'free') redirect('/pricing?upgrade=basic&module=hunting')

  return (
    <div className="min-h-dvh bg-base text-primary flex flex-col">
      <ModuleHeader userId={user.id} email={user.email ?? ''} messagesHref="/hunting/community/messages" />
